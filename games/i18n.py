...
TRANSLATIONS = {
    'pt': {
        ...
        'ranked_login_help': 'Crie uma conta para jogar ranqueadas, salvar histÃ³rico e aparecer no ranking.',
    ...
    'es': {
        ...
        'ranked_login_help': 'CreÃ¡ una cuenta para jugar rankeadas, guardar historial y aparecer en el ranking.',
        'ranked_login_required': 'CreÃ¡ una cuenta para jugar rankeadas.',
        'opponent': 'Oponente',
